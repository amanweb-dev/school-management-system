      ...
      <div id="sidebar" class="nav-collapse sidebar-bg ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="form.php">Fill Up Form</a></li>
              <li><a class="" href="student_info.php">All Student Info</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;" class="">
            ...
            <ul class="sub">
              <li><a class="" href="std_register.php">Register</a></li>
              <li><a class="" href="show_reg_std.php">Registered Student</a></li>
            </ul>
          </li>
        </ul>
        <!-- sidebar menu end-->
